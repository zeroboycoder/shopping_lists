...
class ShopListController extends Component {
   ...
   render() {
      const lists = this.props.items.map((item) => (
         <ShopItem
            key={item._id}
            clicked={() => this.DeleteItemHandler(item._id)}
         >
      ...
      const modalConfig = (
         <div>
            <Backdrop
               ...
               clicked={this.CancleAddItemHandler}
            />
            <Modal
               showed={this.state.isShow}
               clicked={this.CancleAddItemHandler}
            >
               ...
               <div>
                  <input
                     ...
                     onChange={(event) => this.CheckValidation(event)}
                     className="UserInput"
               ...
               <Button
                  btnClass={"Button BtnBold"}
                  clicked={this.AddItemHandler}
                  showed={this.state.isValid}
               >
                  Add
               </Button>
            </Modal>
                  ...
                  <div className="container">
                     ...
                     <div className="row">
                        <div className="col col-md-6 p-3">
                           <div
                              className="AddBtn"
                              onClick={this.ShowAddItemHandler}
                           >
                              Add +
                           </div>
                           {lists}
